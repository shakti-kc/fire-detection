  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.additional_info}>
        ...
        <div>
          <p>Report</p>
          <Link href="https://kcshakti.com.np/Forest%20Fire%20Detection%20Project%20Report.pdf">Link to report</Link>
        </div>
        <div>
          <p>Video</p>
          <Link href="">Link to youtube video</Link>
        </div>
        <div>
          <p>Source code</p>
          <Link href="">Link to Github(Arduino + Website Code)</Link>
        </div>
      </div>
    </div>
  );
